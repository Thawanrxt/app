    ...
    try {
      const response = await fetch(`${API_URL}/activities/save`, {
        ...
        body: JSON.stringify({
          plan_id: plotId,
          type_id: 7,
          operator_name: "ระบบบันทึกการขาย",
  ...
  return (
    <div className={styles.page}>
      <header className={styles.header}>
        <BackButton onClick={() => router.push(`/plant-tracking/${encodeURIComponent(plotId)}`)} className={styles.backBtn} />
        <h1>การขายข้าว</h1>
      </header>
