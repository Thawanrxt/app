...
import { Wind, Droplets, MapPin, ChevronLeft } from "lucide-react";
...
const NAV_ITEMS = [
  { icon: "🏠", label: "หน้าหลัก", path: "/home", active: false },
  { icon: "☀️", label: "อากาศ", path: "/weather", active: true },
  { icon: "🗺️", label: "แผนที่", path: "/map", active: false },
  { icon: "👥", label: "รายงาน", path: "/reports", active: false },
  { icon: "⋯", label: "ตั้งค่า", path: "/settings", active: false },
];
