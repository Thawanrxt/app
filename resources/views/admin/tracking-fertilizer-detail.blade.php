...
@section('title', 'รายละเอียดการหว่านปุ๋ย')
@section('content')
@php
  $statusOptions = [
...
<div class="page-head">
  <div class="page-title">
    <a class="back-link icon-only" href="/admin/tracking/fertilizer" aria-label="กลับไปหน้าการหว่านปุ๋ย">
      <span class="back-icon">‹</span>
    </a>
    <div>
      <h1>รายละเอียดการหว่านปุ๋ย</h1>
    </div>
  </div>
</div>
...
<div class="detail-layout" style="margin-top:16px;">
  <div class="card">
    ...
    <div class="detail-line"><span class="detail-label">ประเภทปุ๋ย :</span>{{ $activity->fertilizer_type ?: '-' }}</div>
    <div class="detail-line"><span class="detail-label">ปริมาณที่ใช้ :</span>{{ $activity->amount_per_rai ?: '-' }}</div>
    ...
    @if ($activity->image_url)
      <img class="detail-image" src="{{ $activity->image_url }}" alt="รูปการหว่านปุ๋ย">
    @else
  ...
  <div class="detail-side">
    <div class="card">
      ...
      @endif
      <form method="POST" action="/admin/tracking/fertilizer/{{ $activity->id }}/status" style="margin-top:10px;">
        @csrf
