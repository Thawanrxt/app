...
<div class="page-head">
  <div>
    <h1>การจัดการโรคพืช</h1>
    <p class="muted">รายการกิจกรรมที่ส่งเข้ามาจากฝั่งยูสเซอร์สำหรับการจัดการโรคพืช</p>
  </div>
  <a class="btn primary" href="/admin/tracking/disease/print" target="_blank" rel="noopener">Export PDF</a>
</div>
...
<div class="card" style="margin-top: 16px;">
  <form class="prep-filters" method="GET" action="/admin/tracking/disease">
        ...
        <tr>
          ...
          <td>
            <div style="display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
              <a class="btn ghost btn-sm" href="/admin/tracking/disease/detail/{{ $activity->id }}">ดูรายละเอียด</a>
              <form method="POST" action="/admin/tracking/disease/{{ $activity->id }}/delete" data-confirm-delete="ยืนยันลบรายการติดตามนี้ใช่หรือไม่?" style="margin:0;">
                @csrf
