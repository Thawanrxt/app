...
<div class="page-head">
  <div>
    <h1>หว่านปุ๋ย</h1>
    <p class="muted">รายการกิจกรรมที่ส่งเข้ามาจากฝั่งยูสเซอร์สำหรับการหว่านปุ๋ย</p>
  </div>
  <a class="btn primary" href="/admin/tracking/fertilizer/print" target="_blank" rel="noopener">Export PDF</a>
</div>
...
<div class="card" style="margin-top: 16px;">
  <form class="prep-filters" method="GET" action="/admin/tracking/fertilizer">
        ...
        <tr>
          ...
          <td>
            <div style="display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
              <a class="btn ghost btn-sm" href="/admin/tracking/fertilizer/detail/{{ $activity->id }}">ดูรายละเอียด</a>
              <form method="POST" action="/admin/tracking/fertilizer/{{ $activity->id }}/delete" data-confirm-delete="ยืนยันลบรายการติดตามนี้ใช่หรือไม่?" style="margin:0;">
                @csrf
