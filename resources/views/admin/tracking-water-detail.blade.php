...
@section('title', 'รายละเอียดการจัดการน้ำ')
@section('content')
@php
  $statusOptions = [
...
<div class="page-head">
  <div class="page-title">
    <a class="back-link icon-only" href="/admin/tracking/water" aria-label="กลับไปหน้าการจัดการน้ำ">
      <span class="back-icon">‹</span>
    </a>
    <div>
      <h1>รายละเอียดการจัดการน้ำ</h1>
    </div>
  </div>
</div>
...
<div class="detail-layout" style="margin-top:16px;">
  <div class="card">
    ...
    <div class="detail-line"><span class="detail-label">ระดับน้ำในแปลง :</span>{{ $activity->water_level ?: '-' }}</div>
    ...
    @if ($activity->image_url)
      <img class="detail-image" src="{{ $activity->image_url }}" alt="รูปการจัดการน้ำ">
    @else
  ...
  <div class="detail-side">
    <div class="card">
      ...
      @endif
      <form method="POST" action="/admin/tracking/water/{{ $activity->id }}/status" style="margin-top:10px;">
        @csrf
