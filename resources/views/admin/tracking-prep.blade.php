...
<div class="page-head">
  <div>
    <h1>การเตรียมดิน</h1>
    <p class="muted">รายการกิจกรรมที่ส่งเข้ามาจากฝั่งยูสเซอร์สำหรับการเตรียมดิน</p>
  </div>
  <a class="btn primary" href="/admin/tracking/prep/print" target="_blank" rel="noopener">Export PDF</a>
</div>
...
<div class="card" style="margin-top: 16px;">
  <form class="prep-filters" method="GET" action="/admin/tracking/prep">
...
<div class="card" style="margin-top: 16px;">
  <table class="table">
    ...
    <tbody>
        ...
        <tr>
          ...
          <td>
            <div style="display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
              <a class="btn ghost btn-sm" href="/admin/tracking/prep/detail/{{ $activity->id }}">ดูรายละเอียด</a>
              <form method="POST" action="/admin/tracking/prep/{{ $activity->id }}/delete" data-confirm-delete="ยืนยันลบรายการติดตามนี้ใช่หรือไม่?" style="margin:0;">
                @csrf
      ...
      @empty
        <tr>
          <td colspan="8" class="muted" style="text-align:center; padding:24px;">ยังไม่มีข้อมูลจากฝั่งยูสเซอร์</td>
        </tr>
      @endforelse
    </tbody>
  </table>
